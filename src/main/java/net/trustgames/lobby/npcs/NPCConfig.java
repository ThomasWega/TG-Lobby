...
public class NPCConfig {
    ...
    public void createDefaults() {
        ...
        config.addDefault("npcs.npc2.hologram", List.of("&e&lCLICK TO PLAY", "&cSERVER-1", "&77 players"));
        ...
        config.addDefault("npcs.npc3.hologram", List.of("&e&lCLICK TO PLAY", "&cSERVER-1", "&77 players"));
